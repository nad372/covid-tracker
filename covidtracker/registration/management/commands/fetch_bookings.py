...
class BookingsFetcher:
    ...
    def get_user_token(self, company_login, user_login, user_password):
        """
    ...
    def get_client(self, login, token):
        """
    ...
    def make_bookings_csv_df(self, bookings, admin_client):
    ...
    def make_bookings_df(self, bookings, admin_client):
        """
    ...
    def make_excel_files_from_bookings(self, df):
        """
